...
export function IngredientEditor({
  ...
  return (
    <div className="border-b border-neutral-200 bg-neutral-50 px-3 py-4">
      ...
      <label className="mt-3 block text-base text-neutral-500">
        Unit
        <input
          value={unit}
      ...
      {catalog.dishes.length > 0 && (
        <div className="mt-4">
          <p className="text-base text-neutral-500">Dishes</p>
