...
export function ReorderList<T>({ items, getId, renderRow, onReorder, hideHandle }: Props<T>) {
  ...
  return (
    <div ref={containerRef} className={`relative ${drag ? 'select-none' : ''}`}>
      {drag && (
        <div
          className="pointer-events-none absolute right-0 left-0 z-20 h-0.5 bg-neutral-900"
            ...
            <div className="flex items-stretch">
              {!hideHandle?.(item) && (
                <button
                  ...
                  className="flex w-11 shrink-0 cursor-grab touch-none items-center justify-center text-neutral-400 active:cursor-grabbing"
